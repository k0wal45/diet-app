import { Diet, Product } from "./Types";
        ...
        meal: {
          ...
          mealProducts: [
            ...
            },
            {
              ...
              productId: 12,
              quantity: 50,
              product: MOCK_PRODUCTS.find((p) => p.id === 12),
            },
          ],
        },
      },
        ...
        meal: {
          ...
          mealProducts: [
            ...
            },
            {
              ...
              productId: 8,
              quantity: 50,
              product: MOCK_PRODUCTS.find((p) => p.id === 8),
            },
          ],
        },
      },
          ...
          mealProducts: [
            {
              ...
              productId: 11,
              quantity: 250,
              product: MOCK_PRODUCTS.find((p) => p.id === 11),
            },
            {
              id: 14,
              mealId: 202,
              productId: 10,
              quantity: 400,
              product: MOCK_PRODUCTS.find((p) => p.id === 10),
            },
            {
              id: 15,
              mealId: 202,
          ...
          mealProducts: [
            {
              ...
              productId: 9,
              quantity: 200,
              product: MOCK_PRODUCTS.find((p) => p.id === 9),
            },
            {
              id: 23,
              mealId: 702,
